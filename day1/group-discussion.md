...
Objectives:
- Review shell and git commands we learned on the first day.
````
...
3. What `git` commands did you learn, and what do they do?
4. How will you collaborate on your project? What are the specific steps for having your change added to a repository?

When you're finished with this discussion, take the Day 1 Quiz on bCourses and continue to the group assignment.
