...
# Project logo option
html_logo = "_static/msse_logo.svg"
...
html_theme_options = {
	...
	"logo": {
      "image_light": "_static/msse_logo.svg",
      "image_dark": "_static/msse_logo.svg",
      "text": "UC Berkeley MSSE - Chem 280",
